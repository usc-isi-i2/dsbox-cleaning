...
setup(name='dsbox-datacleaning',
      ...
      entry_points={
          'd3m.primitives': [
              ...
              'data_augmentation.datamart_query.DSBOX = dsbox.datapreprocessing.cleaner:QueryFromDataframe',
              'data_augmentation.datamart_join.DSBOX = dsbox.datapreprocessing.cleaner:DatamartJoin',
